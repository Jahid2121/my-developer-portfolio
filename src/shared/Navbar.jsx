...
<nav className="bg-custom-background  dark:bg-gray-900 fixed w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600">
  ...
  <span className="flex items-center space-x-3 rtl:space-x-reverse">
      <span className="self-center  text-2xl font-semibold whitespace-nowrap dark:text-white">Jahid's Portfolio</span>
  </span>
  <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
    ...
    <Link to="https://github.com/Jahid2121">
    <div className="timeline-end  text-5xl"> <FaLinkedin /></div></Link>
  ...
  <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
    <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium  rounded-lg  md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-custom-background text-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
      <li>
        <NavLink href="#" className="block py-2 px-3 text-white bg-blue-700 rounded md:bg-transparent md:text-artificialPink md:p-0 md:dark:text-blue-500" aria-current="page">Home</NavLink>
      </li>
      <li>
